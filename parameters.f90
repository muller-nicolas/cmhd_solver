...
integer, parameter :: ndeltaT = 5000
integer, parameter :: inrj = 10
integer, parameter :: ispec = 500  !*********must be a multiple of inrj
integer, parameter :: ifields = 500  !*********must be a multiple of inrj
...
double precision, parameter :: off = 1.d1   !*********forcing => off = 1.d0
double precision, parameter :: width = 1.   !*********forcing width (gaussian forcing)
double precision, parameter :: corr0 = 0.05   !*********forcing correlation 
