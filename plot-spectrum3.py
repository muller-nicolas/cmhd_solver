...
filenames = ['out_spectrumrho-1D-101',
            #  'out_spectrumrho-1D-106',
            #  'out_spectrumrho-1D-107',
            #  'out_spectrumrho-1D-108',
            #  'out_spectrumrho-1D-109']
            ]

ista = 100
iend = 109
iskip = 1
filenames = [f'out_spectrumrho-1D-{i:03d}' for i in range(ista,iend+1,iskip)]
...
plt.legend()
# plt.savefig("Figure-spectrum-rho.png")
plt.show()
