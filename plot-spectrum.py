...
filenames = ['out_spectrumEU-1D-101',
            #  'out_spectrumEU-1D-106',
            #  'out_spectrumEU-1D-107',
            #  'out_spectrumEU-1D-108',
            #  'out_spectrumEU-1D-109'
            ]

ista = 100
iend = 109
iskip = 1
filenames = [f'out_spectrumEU-1D-{i:03d}' for i in range(ista,iend+1,iskip)]
