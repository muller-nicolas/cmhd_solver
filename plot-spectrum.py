...
S1 = np.loadtxt('out_spectrumEU-2D-101')
S2 = np.loadtxt('out_spectrumEU-2D-106')
S3 = np.loadtxt('out_spectrumEU-2D-107')
S4 = np.loadtxt('out_spectrumEU-2D-108')
S5 = np.loadtxt('out_spectrumEU-2D-109')
